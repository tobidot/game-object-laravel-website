...
function (_super) {
  ...
  MedTivaServerApi.prototype.build = function (data) {
    return this.action('build', data);
  };

  MedTivaServerApi.prototype.move = function (data) {
    return this.action('move', data);
  };
...
/***/ "./resources/ts/games/med-tiva/views/MedTivaMapView.ts":
/*!*************************************************************!*\
  !*** ./resources/ts/games/med-tiva/views/MedTivaMapView.ts ***!
  \*************************************************************/
...
exports.MedTivaMapView = void 0;

var MedTivaMapView =
/** @class */
function () {
  function MedTivaMapView(map) {
    this.map = map;
    this.fields = new Map();
    this.field_elements = new Map();
    map.className = "map";
  ...
  MedTivaMapView.prototype.refresh = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        return [2
        /*return*/
        , window.api.get_fields([]).then(function (fields) {
          fields.forEach(function (field) {
            _this.fields.set([field.x, field.y].join(','), field);
          });
          return _this;
        })];
      });
  ...
  MedTivaMapView.prototype.redraw = function () {
    var e_1, _a;

    var _b;

    var field_types = ["plane", "cave", "city"];

    try {
      for (var _c = __values(this.field_elements.values()), _d = _c.next(); !_d.done; _d = _c.next()) {
        var element = _d.value;
        var field = this.fields.get(element.getAttribute('data-key'));
        element.className = "field field-type--" + field_types[(_b = field === null || field === void 0 ? void 0 : field.base_type) !== null && _b !== void 0 ? _b : 0];
      }
    } catch (e_1_1) {
      e_1 = {
        error: e_1_1
  ...
  return MedTivaMapView;
}();

exports.MedTivaMapView = MedTivaMapView;
...
var MedTivaMapView_1 = __webpack_require__(/*! ./views/MedTivaMapView */ "./resources/ts/games/med-tiva/views/MedTivaMapView.ts");
...
(function () {
  ...
  var map = new MedTivaMapView_1.MedTivaMapView(map_element);
  map.refresh().then(function () {
    map.redraw();
  });
})();
})();
